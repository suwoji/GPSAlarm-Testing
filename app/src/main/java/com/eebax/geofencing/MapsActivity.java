...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enterCheck = (CheckBox) findViewById(R.id.enterCheckBox);
        exitCheck = (CheckBox) findViewById(R.id.exitCheckBox);
    }
    ...
    private void addGeofence(LatLng latLng, float radius) {
        if(enterCheck.isChecked()){
            ...
            if(exitCheck.isChecked()){
                ...
                Toast.makeText(getApplicationContext(), "ne vibran mode", Toast.LENGTH_SHORT);
            }
        }
